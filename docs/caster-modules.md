...
The adaptation entailed minor modifications to the bottom portion of the module.
...
Follow these steps to secure two motors to the motor plate:
...
!!! tip
    ...
    Do not force it in, as this can make removal very difficult.
...
!!! tip
    ...
    When the center column is fully inserted into the base pulley, it should be fixed in place, as in the right image.
...
!!! note
    ...
    To mitigate this potential issue, the 3D printing instructions for wheel mount B include reinforced walls (1.6mm instead of the default 0.8mm)
...
!!! note
    ...
    Do not overtighten these screws, as it may make it difficult to insert the wheel in the next step.
